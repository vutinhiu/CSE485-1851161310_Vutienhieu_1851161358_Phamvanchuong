            ...
            <div class="col-xs-12 col-sm-6 col-md-12">
                <form name="myForm" action="" method="POST" onsubmit="return validateForm()" required>
                    <div class="form-group"> 
                        Tài khoản không tồn tại hoặc sai mật khẩu tài khoản
                        <br>
                    ...
                    <div class="form-groupa">
                        <input type="submit" class="form-control " name="sbmLogin"href="includes/process-login.php" id="sbmLogin" value="Login">
                         <p>
